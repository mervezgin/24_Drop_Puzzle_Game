...
public class CreateShape : MonoBehaviour
{
    ...
    [SerializeField] List<QuarterObjectSO> allQuarterColorList;
    [SerializeField] private Transform fullQuarter;
    private QuarterObjectSO quarterObjectSO;
    ...
    public void CreateShapeLast()
    {
        for (int i = 0; i < allTransformList.Count; i++)
        {
            ...
            QuarterObjectSO selectedQuarter = allQuarterColorList[randomIndex];
            ...
            Transform fullShape = Instantiate(selectedQuarter.quarterPrefab, allTransformList[i], Quaternion.identity);
    ...
    public void GetQuarterColor()
    {
        foreach (Transform child in fullQuarter)
        {
